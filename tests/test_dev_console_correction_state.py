...
class DevConsoleCorrectionStateTest(unittest.TestCase):
    ...
    def test_uses_runtime_correction_debug_when_reported(self):
        ...
        redis_client.hset("correctionDebug", "rawLat", "32.1")
        redis_client.hset("correctionDebug", "rawLon", "118.1")
        redis_client.hset("correctionDebug", "filteredLat", "32.100001")
        redis_client.hset("correctionDebug", "filteredLon", "118.100001")
        redis_client.hset("correctionDebug", "controlSource", "kalman_p_control")
        ...
        self.assertEqual(state["correction"]["controlSource"], "kalman_p_control")
        self.assertEqual(state["correction"]["rawLocation"]["lat"], 32.1)
        self.assertEqual(state["correction"]["filteredLocation"]["lon"], 118.100001)
